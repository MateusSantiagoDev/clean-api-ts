...
describe('DbLoadAccountByToken Usecase', () => {
  ...
  test('deve retornar nulo se o Decrypter retornar nulo', async () => {
    const { sut, decrypterStub } = makeSut()
  ...
  // integração
  test('deve chamar LoadAccountByTokenRepository com valores corretos', async () => {
  ...
  test('deve retornar nulo se o LoadAccountByTokenRepository retornar nulo', async () => {
    const { sut, loadAccountByTokenRepositoryStub } = makeSut()
  ...
  // excessão
  test('deve falhar se o Decrypter falhar', async () => {
    const { sut, decrypterStub } = makeSut()
  ...
  // excessão
  test('deve falhar se o LoadAccountByTokenRepository falhar', async () => {
    const { sut, loadAccountByTokenRepositoryStub } = makeSut()
